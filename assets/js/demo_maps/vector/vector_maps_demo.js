  ...
  var _vectorMapsExamples = function () {
    ...
    $(".map-world-markers").vectorMap({
      ...
      markers: [
        ...
        { latLng: [19.4, -99.124], name: "Mexico City" },
        ...
        { latLng: [45.41, -75.7], name: "Ottawa" },
        { latLng: [53.555, -113.493], name: "Edmonton" },
        { latLng: [-0.23, -78.52], name: "Quito" },
        { latLng: [18.5, -69.99], name: "Santo Domingo" },
        ...
        { latLng: [-3.79, -38.518], name: "Fortaleza" },
        ...
        { latLng: [47.481, 19.13], name: "Budapest" },
    ...
    $.getJSON("assets/demo_data/maps/vector/unemployment.json", function (
      data
    ) {
      // Year
      var val = 2009;
      ...
      (statesValues = jvm.values.apply({}, jvm.values(data.states))),
        (metroPopValues = Array.prototype.concat.apply(
          [],
          jvm.values(data.metro.population)
        )),
        (metroUnemplValues = Array.prototype.concat.apply(
          [],
