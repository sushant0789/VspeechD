  ...
  var _componentNoty = function (lang) {
    ...
    new Noty({
      text:
        ...
        lang +
        '"</span>' +
        " locale is missing. Loading fallback language.",
      type: "error",
      theme: "limitless",
      layout: "topRight",
      timeout: 2500,
  ...
  var _componentI18nextFallback = function () {
    ...
    i18next.on("initialized", function () {
      ...
      // Spanish
        ...
        $(".navbar-nav-link" + spanishLangClass)
          .parent()
          .addClass("active");
        ...
        $switchContainer
          .children(".dropdown-toggle")
          .html($switchContainer.find(spanishLangClass).html())
          .children("img")
          .addClass("mr-2");
      }
      ...
      // Italian
        ...
        $(".navbar-nav-link" + italianLangClass)
          .parent()
          .addClass("active");
        ...
        $switchContainer
          .children(".dropdown-toggle")
          .html($switchContainer.find(italianLangClass).html())
          .children("img")
          .addClass("mr-2");
      } else {
        // Change language
