...
var Modals = (function () {
  ...
  var _componentModalRemote = function () {
    $("#modal_remote").on("show.bs.modal", function () {
      $(this)
        .find(".modal-body")
        .load("assets/demo_data/wizard/education.html", function () {
          _componentSelect2();
        });
    });
  };
  ...
  var _componentModalBootbox = function () {
    ...
    $("#alert").on("click", function () {
      bootbox.alert({
        ...
        message:
          "Native alert dialog has been replaced with Bootbox alert box.",
      });
    });
    ...
    $("#confirm").on("click", function () {
      bootbox.confirm({
        ...
        message:
          "Native confirm dialog has been replaced with Bootbox confirm box.",
        buttons: {
          confirm: {
            label: "Yes",
