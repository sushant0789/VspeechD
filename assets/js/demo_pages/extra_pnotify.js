  ...
  var _componentPnotify = function () {
    ...
    $("#pnotify-custom-styled").on("click", function () {
      new PNotify({
        ...
        text: "Check me out! I'm a notice.",
        addclass:
          "alert alert-styled-left alert-styled-custom alert-arrow-left alpha-teal text-teal-800 border-teal",
      });
    });
    ...
    $("#pnotify-desktop-default").on("click", function () {
      ...
      new PNotify({
        ...
        text:
          "If you've given me permission, I'll appear as a desktop notification.",
        desktop: {
          desktop: true,
    ...
    $("#pnotify-desktop-danger").on("click", function () {
      ...
      new PNotify({
        ...
        type: "danger",
        text:
          "I'm a danger desktop notification, if you have given me a permission.",
        desktop: {
          desktop: true,
    ...
    $("#pnotify-desktop-info").on("click", function () {
      ...
      new PNotify({
        ...
        type: "info",
        text:
          "I'm an info desktop notification, if you have given me a permission.",
        desktop: {
          desktop: true,
    ...
    $("#pnotify-sticky-buttons").on("click", function () {
      new PNotify({
        ...
        text:
          "I'm a sticky notice with no unsticky button. You'll have to close me yourself.",
        addclass: "bg-primary border-primary",
        hide: false,
        buttons: {
          sticker: false,
    ...
    $("#pnotify-permanent-buttons").on("click", function () {
      new PNotify({
        ...
        text:
          "My buttons are really lonely, so they're gonna hang out with us.",
        addclass: "bg-slate border-slate",
        buttons: {
          closer_hover: false,
          sticker_hover: false,
    ...
    $("#pnotify-permanotice").on("click", function () {
      ...
      if (permanotice) {
        ...
        permanotice = new PNotify({
          title: "Now look here",
          text:
            "There's something you need to know, and I won't go away until you come to grips with it.",
          addclass: "bg-danger border-danger",
          hide: false,
          buttons: {
            closer: false,
    ...
    function show_stack_top_left(type) {
      var opts = {
        ...
        stack:
          $("html").attr("dir") == "rtl" ? stack_top_left_rtl : stack_top_left,
      };
      switch (type) {
        case "error":
          opts.title = "Oh No";
    ...
    function show_stack_custom_left(type) {
      var opts = {
        ...
        text: "Check me out. I'm in a different stack.",
        addclass:
          "stack-custom-left bg-primary border-primary alert-styled-right",
        stack:
          $("html").attr("dir") == "rtl"
            ? stack_custom_left_rtl
            : stack_custom_left,
      };
      switch (type) {
        case "error":
