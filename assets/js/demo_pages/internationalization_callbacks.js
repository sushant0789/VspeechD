...
var I18nextCallbacks = (function () {
  ...
  var _componentI18nextCallbacks = function () {
    ...
    i18next.on("initialized", function () {
      // Notification
      _componentNoty(
        "i18Next has been initialized. <br> The following language has beed detected: " +
      ...
      if (i18next.language === "en") {
        ...
        $(".navbar-nav-link" + englishLangClass)
          .parent()
          .addClass("active");
        ...
        $switchContainer
          ...
          .html($switchContainer.find(englishLangClass).html())
          .children("img")
          .addClass("mr-2");
      }
      ...
      if (i18next.language === "ru") {
        ...
        $(".navbar-nav-link" + russianLangClass)
          .parent()
          .addClass("active");
        ...
        $switchContainer
          .children(".dropdown-toggle")
          .html($switchContainer.find(russianLangClass).html())
          .children("img")
          .addClass("mr-2");
      }
      ...
      if (i18next.language === "ua") {
        ...
        $(".navbar-nav-link" + ukrainianLangClass)
          .parent()
          .addClass("active");
        ...
        $switchContainer
          .children(".dropdown-toggle")
          .html($switchContainer.find(ukrainianLangClass).html())
          .children("img")
          .addClass("mr-2");
      }
    });
    ...
    $(englishLangClass).on("click", function () {
      ...
      $switchContainer
        .children(".dropdown-toggle")
        .html($(englishLangClass).html())
        .children("img")
        .addClass("mr-2");

      // Set active class
      $switchContainer
        .find(".dropdown-item.active, .nav-item.active")
        .removeClass("active");
      $(".dropdown-item" + englishLangClass).addClass("active");
      $(".navbar-nav-link" + englishLangClass)
        .parent()
