...
var JqueryUiForms = (function () {
  ...
  var _componentUiAutocomplete = function () {
    ...
    $("#ac-custom")
      ...
      return $("<li>")
        .append(
          '<span class="font-weight-semibold pb-0">' +
            item.label +
            "</span>" +
            '<div class="text-muted font-size-sm pt-0">' +
            item.desc +
            "</div>"
        )
        .appendTo(ul);
    ...
    $("#ac-caching").autocomplete({
      ...
      source: function (request, response) {
        ...
        $.getJSON(
          "assets/demo_data/jquery_ui/autocomplete.php",
          request,
    ...
    $.widget("custom.combobox", {
      ...
      _createShowAllButton: function () {
        ...
        this.wrapper.append(
          '<div class="form-control-feedback"><i class="icon-search4 font-size-base"></i></div>'
        );
