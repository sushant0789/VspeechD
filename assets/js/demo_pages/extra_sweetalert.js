...
var SweetAlert = (function () {
  ...
  var _componentSweetAlert = function () {
    ...
    $("#sweet_html").on("click", function () {
      swalInit.fire({
        title:
          '<i>HTML</i> &nbsp; <span class="font-weight-light">example</span>',
        type: "info",
        html:
    ...
    $("#sweet_bg").on("click", function () {
      swalInit.fire({
        ...
        background:
          "#fff url(assets/images/backgrounds/boxed_bg_retina.png) repeat",
      });
    });
    ...
    $("#sweet_combine").on("click", function () {
      swalInit
        ...
        .then(function (result) {
          if (result.value) {
            swalInit.fire("Deleted!", "Your file has been deleted.", "success");
        ...
        .then(function (result) {
          if (result.value) {
            swalInit.fire({
              ...
              html:
                "You selected: " +
                JSON.stringify($(".swal2-select.select-multiple").val()),
            });
          }
        });
    });
      ...
      swalInit
        ...
        .then(function (result) {
          ...
          swalInit.fire({
            ...
            html:
              "You selected: " +
              JSON.stringify($(".swal2-select.select-multiselect").val()),
          });
