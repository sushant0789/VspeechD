...
var AlpacaAdvanced = (function () {
  ...
  var _componentAlpacaAdvanced = function () {
    ...
    if (!$alpacaEditorLTR.length == 0) {
      $alpacaEditorLTR.alpaca({
        data:
          "Ice cream is a <b>frozen</b> dessert usually made from <i>dairy products</i>, such as milk and cream, and often combined with fruits or other ingredients and flavors.",
        options: {
          type: "ckeditor",
        },
      });
  ...
  var _componentAlpacaAdvancedUniform = function () {
    if (!$().alpaca || !$().uniform) {
      console.warn(
        "Warning - alpaca.min.js and/or uniform.min.js is not loaded."
      );
      return;
    }
