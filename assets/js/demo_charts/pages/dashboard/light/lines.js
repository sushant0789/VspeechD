...
var DashboardLines = (function () {
  ...
  var _AppSalesLinesChart = function (element, height) {
    ...
    if ($(element).length > 0) {
      ...
      d3.csv("assets/demo_data/dashboard/app_sales.csv", function (
        error,
        data
      ) {
        formatted = data;
      ...
      function redraw() {
        ...
        svg
          ...
          .attr(
            "class",
            "d3-axis d3-axis-vertical d3-axis-transparent d3-grid d3-grid-dashed"
          );
        ...
        // Bind the data
        var lines = svg.selectAll(".app-sales-lines").data(linedata);
        ...
        sidebarToggle &&
          sidebarToggle.addEventListener("click", appSalesResize);
