...
var D3Streamgraph = (function () {
  ...
  var _streamgraph = function () {
    ...
    if (element) {
      ...
      d3.csv("assets/demo_data/dashboard/traffic_sources.csv", function (
        error,
        data
      ) {
        // Pull out values
        ...
        // Hide first tick
        d3.select(svg.selectAll(".d3-axis-left .tick text")[0][0]).style(
          "visibility",
          "hidden"
        );
        ...
        // Hide first tick
        d3.select(svg.selectAll(".d3-axis-right .tick text")[0][0]).style(
          "visibility",
          "hidden"
        );
              ...
              tooltip
                .html(
                  '<ul class="list-unstyled mb-1 p-0">' +
                    "<li>" +
                    '<div class="font-size-base my-1"><i class="icon-circle-left2"></i><span class="d-inline-block ml-2"></span>' +
                    d.key +
                    "</div>" +
                    "</li>" +
                    "<li>" +
        ...
        d3Container.on("mousemove", function (d, i) {
          ...
          if (
            ...
            tooltip
              .style(
                "left",
                mousex - $(".d3-tip").outerWidth() - tooltipOffset + "px"
