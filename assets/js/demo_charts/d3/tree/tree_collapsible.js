...
var D3TreeCollapsible = (function () {
  ...
  var _treeCollapsible = function () {
    ...
    if (element) {
      ...
      // Tree
      var tree = d3.layout.tree().size([height, width - 180]);
      ...
      d3.json("assets/demo_data/d3/tree/tree_data_collapsible.json", function (
        error,
        json
      ) {
        root = json;
      ...
      function update(source) {
        ...
        // Update the nodes…
        var node = svg.selectAll(".d3-tree-node").data(nodes, function (d) {
          return d.id || (d.id = ++i);
        });
