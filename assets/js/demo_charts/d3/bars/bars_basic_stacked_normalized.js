...
var D3BarNormalized = (function () {
  ...
  var _barNormalized = function () {
    ...
    if (element) {
      ...
      // Color
      var color = d3.scale.ordinal().range(bar_colors);
      ...
      d3.csv("assets/demo_data/d3/bars/bars_stacked.csv", function (
        error,
        data
      ) {
        ...
        // Vertical
        svg.append("g").attr("class", "d3-axis d3-axis-vertical").call(yAxis);
        ...
        var legend = svg
          ...
          .attr("transform", function (d) {
            return (
              "translate(" + x.rangeBand() + "," + y((d.y0 + d.y1) / 2) + ")"
            );
          });
