...
var D3BarStackedMultiple = (function () {
  ...
  var _barStackedMultiple = function () {
    ...
    if (element) {
      ...
      d3.tsv("assets/demo_data/d3/bars/bars_stacked_multiple.tsv", function (
        error,
        data
      ) {
        // Pull out values
        ...
        // Horizontal
        x.domain(
          dataByGroup[0].values.map(function (d) {
            return d.date;
          })
        );
        ...
        var timeout = setTimeout(function () {
          d3.selectAll('input[value="stacked"]')
