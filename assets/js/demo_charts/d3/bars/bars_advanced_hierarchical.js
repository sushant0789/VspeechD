...
var D3BarHierarchy = (function () {
  ...
  var _barHierarchy = function () {
    ...
    if (element) {
      ...
      d3.json("assets/demo_data/d3/bars/bars_hierarchical.json", function (
        error,
        root
      ) {
      ...
      function down(d, i) {
        ...
        svg.select(".d3-bars-background").datum(d).transition().duration(end);
